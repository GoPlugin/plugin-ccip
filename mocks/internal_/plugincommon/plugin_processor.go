...
import (
	...
	plugincommon "github.com/goplugin/plugin-ccip/internal/plugincommon"
	mock "github.com/stretchr/testify/mock"
)

// MockPluginProcessor is an autogenerated mock type for the PluginProcessor type
type MockPluginProcessor[Query interface{}, Observation interface{}, Outcome interface{}] struct {
	mock.Mock
}

type MockPluginProcessor_Expecter[Query interface{}, Observation interface{}, Outcome interface{}] struct {
	mock *mock.Mock
}
...
type MockPluginProcessor_Observation_Call[Query interface{}, Observation interface{}, Outcome interface{}] struct {
	*mock.Call
}
...
type MockPluginProcessor_Outcome_Call[Query interface{}, Observation interface{}, Outcome interface{}] struct {
	*mock.Call
}
...
type MockPluginProcessor_Query_Call[Query interface{}, Observation interface{}, Outcome interface{}] struct {
	*mock.Call
}
...
type MockPluginProcessor_ValidateObservation_Call[Query interface{}, Observation interface{}, Outcome interface{}] struct {
	*mock.Call
}
...
func NewMockPluginProcessor[Query interface{}, Observation interface{}, Outcome interface{}](t interface {
	mock.TestingT
	Cleanup(func())
