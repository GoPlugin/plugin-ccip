...
func (_m *MockPriceReader) GetFeeQuoterTokenUpdates(ctx context.Context, tokens []ccipocr3.UnknownEncodedAddress, chain ccipocr3.ChainSelector) (map[ccipocr3.UnknownEncodedAddress]plugintypes.TimestampedBig, error) {
	...
	var r0 map[ccipocr3.UnknownEncodedAddress]plugintypes.TimestampedBig
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []ccipocr3.UnknownEncodedAddress, ccipocr3.ChainSelector) (map[ccipocr3.UnknownEncodedAddress]plugintypes.TimestampedBig, error)); ok {
		return rf(ctx, tokens, chain)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []ccipocr3.UnknownEncodedAddress, ccipocr3.ChainSelector) map[ccipocr3.UnknownEncodedAddress]plugintypes.TimestampedBig); ok {
		r0 = rf(ctx, tokens, chain)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[ccipocr3.UnknownEncodedAddress]plugintypes.TimestampedBig)
		}
	}
...
func (_c *MockPriceReader_GetFeeQuoterTokenUpdates_Call) Return(_a0 map[ccipocr3.UnknownEncodedAddress]plugintypes.TimestampedBig, _a1 error) *MockPriceReader_GetFeeQuoterTokenUpdates_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockPriceReader_GetFeeQuoterTokenUpdates_Call) RunAndReturn(run func(context.Context, []ccipocr3.UnknownEncodedAddress, ccipocr3.ChainSelector) (map[ccipocr3.UnknownEncodedAddress]plugintypes.TimestampedBig, error)) *MockPriceReader_GetFeeQuoterTokenUpdates_Call {
	_c.Call.Return(run)
	return _c
}

// GetFeedPricesUSD provides a mock function with given fields: ctx, tokens
func (_m *MockPriceReader) GetFeedPricesUSD(ctx context.Context, tokens []ccipocr3.UnknownEncodedAddress) ([]*big.Int, error) {
	...
	var r0 []*big.Int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []ccipocr3.UnknownEncodedAddress) ([]*big.Int, error)); ok {
		return rf(ctx, tokens)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []ccipocr3.UnknownEncodedAddress) []*big.Int); ok {
		r0 = rf(ctx, tokens)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockPriceReader_GetFeedPricesUSD_Call) RunAndReturn(run func(context.Context, []ccipocr3.UnknownEncodedAddress) ([]*big.Int, error)) *MockPriceReader_GetFeedPricesUSD_Call {
	_c.Call.Return(run)
	return _c
}
