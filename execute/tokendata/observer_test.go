	...
	tests := []struct {
		...
		},
		{
			...
			expectedTokenData: exectypes.TokenDataObservations{
				1: {
					10: exectypes.NewMessageTokenData(
						exectypes.NewSuccessTokenData([]byte("PLI_10_0")),
						exectypes.NewSuccessTokenData([]byte("USDC_10_1")),
					),
					11: exectypes.NewMessageTokenData(
						exectypes.NewSuccessTokenData([]byte("PLI_11_0")),
						exectypes.NewSuccessTokenData([]byte("PLI_11_1")),
					),
				},
			},
		},
			...
			expectedTokenData: exectypes.TokenDataObservations{
				...
				2: {
					12: exectypes.NewMessageTokenData(
						exectypes.NewSuccessTokenData([]byte("PLI_12_0")),
						exectypes.NewNoopTokenData(),
					),
				},
			},
	...
	tests := []struct {
		...
		},
		{
			...
			expectedTokenData: exectypes.TokenDataObservations{
				...
				2: {
					20: exectypes.NewMessageTokenData(exectypes.NewSuccessTokenData([]byte("PLI_20_0"))),
				},
			},
		},
		{
