...
func TestWaitBoostedFee(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			"wait 10s",
			time.Second * 10,
			big.NewInt(6e18), // Fee:   6    PLI

			big.NewInt(1166666666665984), // Boost: 0.01 PLI
			0.07,
		},
		{
			"wait 5m",
			time.Minute * 5,
			big.NewInt(6e18),  // Fee:   6    PLI
			big.NewInt(35e15), // Boost: 0.35 PLI
			0.07,
		},
		{
			"wait 7m",
			time.Minute * 7,
			big.NewInt(6e18),  // Fee:   6    PLI
			big.NewInt(49e15), // Boost: 0.49 PLI
			0.07,
		},
		{
			"wait 12m",
			time.Minute * 12,
			big.NewInt(6e18),  // Fee:   6    PLI
			big.NewInt(84e15), // Boost: 0.84 PLI
			0.07,
		},
		{
			"wait 25m",
			time.Minute * 25,
			big.NewInt(6e18),               // Fee:   6 PLI
			big.NewInt(174999999999998976), // Boost: 1.75 PLI
			0.07,
		},
		{
			"wait 1h",
			time.Hour * 1,
			big.NewInt(6e18),   // Fee:   6 PLI
			big.NewInt(420e15), // Boost: 4.2 PLI
			0.07,
		},
		{
			"wait 5h",
			time.Hour * 5,
			big.NewInt(6e18),                // Fee:   6 PLI
			big.NewInt(2100000000000001024), // Boost: 21PLI
			0.07,
		},
		{
			"wait 24h",
			time.Hour * 24,
			big.NewInt(6e18), // Fee:   6 PLI
			big.NewInt(0).Mul(big.NewInt(10), big.NewInt(1008e15)), // Boost: 100PLI
			0.07,
		},
		{
			"high boost wait 10s",
